...
export default function HomePageClient({ dataByLocale, defaultLocale }: HomePageClientProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-8 py-12 lg:py-20 bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-10 lg:border-l lg:border-neutral-200 lg:pl-12">
